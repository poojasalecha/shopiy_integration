...
class BaseController(object):
    ...
    @return http response with status code
    """ 
    def respond_with_item(self, status_code, data, transformer):
        response = {}
    ...
    @return http response with status code
    """ 
    def respond_with_paginated_collection(self, status_code, data, transformer, page, items):
        response ={}
        response['data'] = self.fetch_data_from_transformer(transformer,data)
        response['pagination'] ={}
        response['pagination']['page'] = page
        response['pagination']['item'] = items
        response['notification'] = {}
        response['notification']['hint'] = "Response Sent"
        response['notification']['message'] = "Success"
